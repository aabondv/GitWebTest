				...
				<div class=" cart-items heading">
					...
					<div class="in-check">
						...
						<ul class="unit">
							...
							<li><span>订单时间</span></li>
							<li><span>商品总数量</span></li>
							<li><span>商品总价</spanzon></li>
							<li><span>订单状态</span></li>
							<li><span>订单收货地址</span></li>
							<!-- <li><span>订单手机</span></li> -->
							<li><span>订单详情</span></li>
							<div class="clearfix"> </div>
						</ul>
						<c:if test="${empty order }">
							<ul class="cart-header">
								<li><span>您的订单为空,<a href="InitServlet">购物</a></span></li>
							</ul>
						</c:if>
						<c:set var="totalprice" value="0"></c:set>
						<c:forEach items="${order }" var="order">
							<ul class="cart-header">
							<li><span>${order.ordersId }</span></li>
							<li><span>${order.orderstime}</span></li>
							<li><span>${order.itemsnum}</span></li>
							<li><span>${order.price}</span></li>
							<li><span>${order.orderstate }</span></li>
							<li><span>${order.orderaddress}</span></li>
							<%-- <li><span>${order.orderphone }</span></li> --%>
							<c:set var="totalprice" value="${totalprice+order.price}"></c:set>
							<li><span><a href="OrderServlet?ordermethod=findOne&orderitemid=${order.ordersItemId}">查看详情</a></span></li>
							<div class="clearfix"> </div>
						</ul>
						</c:forEach>
						<%-- <div id="totalPrice">

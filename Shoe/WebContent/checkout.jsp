				...
				<div class=" cart-items heading">
					...
					<div class="in-check">
						...
						<ul class="cart-header">
							...
							<li class="ring-in">
								<a href="single.jsp">
									<img src="${item.shoes.shoesPictureUrl }" class="img-responsive" alt="">
								</a>
							</li>
							<li><span>${item.shoes.shoesName }</span></li>
							<li><span>${item.shoes.shoesPrice }</span></li>
							<li>
								<span>
									<input type="button" value="-">
									<input type="text" value="${item.cshoesNumber }">
									<input type="button" value="+">
								</span>
							</li>
							<li>
		...
		<script type="text/javascript">
			$(document).ready(function () {
				...
				function addOrder(){
					...
					$.ajax({
						url:"OrderServlet?ordermethod=AddOrderByCart",
						data:{""}
					})
				}
			});

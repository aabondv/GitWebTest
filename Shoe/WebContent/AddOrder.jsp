				...
				<div class=" cart-items heading">
					...
					<div class="in-check">
						...
						<c:set var="totalprice" value="0"></c:set>
							...
							<li><span>${sessionScope.shoes.shoesName}</span></li>
							<li class="ring-in">
								<a href="">
									<img src="${sessionScope.shoes.shoesPictureUrl}" class="img-responsive" alt="">
								</a>
							</li>
							<li><span>${sessionScope.num}</span></li>
							<li><span>${sessionScope.shoes.shoesPrice}</span></li>
						...
						<div>
						 ...
						 <div id="totalPrice">
							<span>总计：</span>
							<span class="price">${sessionScope.num*sessionScope.shoes.shoesPrice }</span>
